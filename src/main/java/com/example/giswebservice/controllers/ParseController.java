...
public class ParseController {
    ...
    @GetMapping(value = "/parse/products/smartphones/")
...
//        return gson.toJson(products);
    ...
    @GetMapping(value = "/parse/products/TV")
...
//        return gson.toJson(products);
    ...
    @GetMapping(value = "/parse/products/laptops")
...
//        return gson.toJson(products);
    ...
    @GetMapping(value = "/parse/products/audio")
